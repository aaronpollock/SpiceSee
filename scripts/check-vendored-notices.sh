...
# Re-run after any edit under Packages/CSpiceCodec/Sources/CSpiceCodec/vendor/ and before cutting a release.
cd "$(dirname "$0")/../Packages/CSpiceCodec/Sources/CSpiceCodec" || exit 1
status=0
